...
async function initiatePayment(movie) {
    ...
    body.append('access_type', 'online');
    ...
    try {
        const response = await fetch('https://sandbox.momodeveloper.mtn.com/collection/v1_0/bc-authorize', {
            ...
            headers: {
                ...
                'Ocp-Apim-Subscription-Key': 'df8b55ab5e7f4fbfac41502e9ef66e56', // Replace with your correct key
            },
        });
        ...
        if (status === 200) {
            ...
            alert('Payment failed. Please use the correct test number and try again.');
        }
    } catch (error) {
        console.error('Payment error:', error);
        alert('Payment request failed. Please check your network and API key.');
    }
}
